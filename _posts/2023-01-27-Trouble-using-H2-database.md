...
H2 is a very light relationship database, and I tried it for [tomato-config-service](https://github.com/khietbt/tomato-config-service) - a demo of Spring Config Server.
