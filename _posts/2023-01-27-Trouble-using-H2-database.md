...
H2 is a very light relational database, and I tried it
for [tomato-config-service](https://github.com/khietbt/tomato-config-service) - a demo of Spring Config Server.

Well, everything looks good, but the properties table has 2 columns: key, value which share the same name with preserved
identifiers and cause this error:
...
[Internet advices](https://stackoverflow.com/questions/19758467/h2-database-column-name-group-is-a-reserved-word) did
not work, but I found the way of liquibase:
